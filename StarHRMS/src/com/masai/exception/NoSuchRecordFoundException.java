...
/**
 * Custom exception class for handling cases where a requested record is not found.
 * This exception is thrown when a specific record is not found in the system or database.
