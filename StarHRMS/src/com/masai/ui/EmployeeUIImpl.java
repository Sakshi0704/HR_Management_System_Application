...
/**
 * Implementation class for the EmployeeUI interface. Provides the
 * implementation for the employee-related functionality. Extends the EmployeeUI
 * class to inherit the common employee methods.
 * 
 * @author Km Sakshi
 */
public class EmployeeUIImpl extends EmployeeUI {
	...
	/**
	 * Displays the menu options for updating employee information. The menu
	 * includes options for updating the address, email ID, and password. The
	 * employee can select the desired option to update their information.
	 */
	 ...
	 * 
	 * Retrieves the employee profile details using the EmployeeDAO and displays
	 * them.
	 * 
	 * If an exception occurs, such as NoSuchRecordFoundException or
	 * SomthingWentWrongException, appropriate error messages are displayed.
	 * 
	 ...
	 * 
	 * If the user selects an invalid option, an appropriate error message is
	 * displayed.
	 * 
	...
	/**
	 * Displays the menu options for selecting a type of leave. The menu includes
	 * options for complementary leave, sick leave, and extra leave.
	 */
	private static void leaveMenu() {
		System.out.println("\n");
		System.out
				.println(ConsoleColor.BLACK_BACKGROUND_BRIGHT + "+--------------------------------------------------+");
	...
	/**
	 * Allows the employee to apply for leave by selecting the type of leave,
	 * specifying the number of days, and providing a reason for the leave.
	 *
	 * The method displays a menu for selecting the type of leave (complementary,
	 * sick, or extra) and prompts the user to enter the number of days and reason
	 * for the leave.
	 * 
	 * It then creates a LeaveDTO object and calls the appropriate method in the
	 * EmployeeDAOImpl class to apply for leave.
	 * 
	 ...
	 *
	 * This method interacts with the EmployeeDAOImpl class to retrieve the leave
	 * record of the employee.
	 * 
	 * It displays the leave record in a formatted table, including employee ID,
	 * employee name, days of leave, leave type, reason, date, and status.
	 *
	 * If the leave record is found and displayed successfully, it indicates the
	 * recent leave history of the employee.
	 * 
	 * 
	 * If an exception occurs or no record is found, it prints an error message to
	 * notify the user.
	 * 
	 * @param sr The scanner object for user input.
	 */
	 ...
	 * 
	 * This method interacts with the EmployeeDAOImpl class to retrieve the total
	 * salary of the employee for the current month.
	 * 
	 * It displays the salary amount with a success message.
	 * 
	 * If any exception occurs during the process, it prints an error message in red
	 * color to notify the user.
	 *
	 * @param sr The scanner object for user input.
	 */
	@Override
	 ...
	 * It displays the salary amount with a success message.
	 * 
	 * If any exception occurs during the process, it prints an error message to
	 * notify the user.
	 * 
	 * @param sr The scanner object for user input.
	 */
