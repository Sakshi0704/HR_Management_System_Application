...
/**
 * Abstract class representing the User Interface for an employee.
 * Provides the basic structure and common methods for employee-related UI classes.
 * 
 *  @author Km Sakshi
 */
public abstract class EmployeeUI {
	 ...
	 * 
	 * The menu includes various actions that an employee can perform such as viewing profile,
	 * updating profile and password, applying for leave, checking leave status, viewing leave records,
	 * calculating monthly and yearly salary, and logging out.
	 */
	 ...
	 * 
	 * Prompts the user to enter their email ID and password, and validates the credentials
	 * using the EmployeeDAO. 
	 * 
	 * If the credentials are valid, the user is logged in and
	 * the employee dashboard is displayed. 
	 * 
	 * If the credentials are invalid, an appropriate
	...
	/**
	 * Handles the employee functionality in the application.
	 * Allows employees to perform various actions based on their selection.
