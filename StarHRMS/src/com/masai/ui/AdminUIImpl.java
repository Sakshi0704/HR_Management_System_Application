...
/**
 * Implementation class for the AdminUI interface. Provides the implementation
 * for the admin-related functionality. Extends the AdminUI class to inherit the
...
public class AdminUIImpl extends AdminUI {
	 ...
	 *
	 * This method prompts the user to enter the details of the new department,
	 * including the department ID and name.
	 * 
	 * It interacts with the AdminDAOImpl class to add the new department to the
	 * record.
	 * 
	 * If the addition is successful, it displays a success message.
	 * 
	 * Otherwise, it prints an error message in red color along with the exception
	 ...
	 *
	 * This method interacts with the AdminDAOImpl class to retrieve a list of all
	 * department details. It then prints the department ID and name for each
	 * department in a formatted table.
	 *
	 ...
	 * employee details.
	 * 
	 * It then prints the employee ID, name, email, password, address, salary,
	 * department ID, department name, and department date of each employee in a
	 * formatted table.
	 *
	 * If there are no employee records or an exception occurs during retrieval, an
	 * error message is displayed with the exception message.
	 *
	 ...
	 * 
	 * The menu includes options for updating the department ID, department name, or
	 * all details of a department.
	 * 
	 ...
	 * 
	 * The user is prompted to choose an option from the menu by entering a
	 * corresponding number.
	 * 
	 * The options include updating the department ID, department name,or all
	 * details of a department.
	 * 
	 * If the user selects option 3, the 'updateDepartmentAllDetailsUI' method is
	 * called to handle the update process. Only this option is working currently
	 * 
	 ...
	 *
	 * This method uses the 'updateMenu' method from the 'AdminUIImpl' class to
	 * display the menu.
	 */
	@Override
	 ...
	 *
	 * This method prompts the user to enter the current department ID (created by
	 * the admin) that needs to be updated.
	 * 
	 * Then, it asks for the updated department ID and department name.
	 * 
	 * The user's input is used to update the department details using the
	 * 'updateDepartmentAllDetails' method from the 'AdminDAO' implementation.
	 * 
	 * If the update is successful, a success message is displayed.
	 * 
	 * If an exception occurs during the update process, an error message is
	 * displayed.
	 *
	 * Note: The department ID provided should match the existing department ID
	 ...
	 *
	 * This method prompts the user to enter the new employee details such as
	 * employee ID, name, email, address, joining date, salary, and department ID
	 * (created by admin).
	 * 
	 * The user's input is used to create an EmployeeDTO object and pass it to the
	 * 'addNewEmployee' method in the 'AdminDAO' implementation along with the
	 * department ID.
	 * 
	 ...
	 *
	 * Note: The employee ID and department ID provided should be unique and match
	 * the existing IDs in the records.
	 * 
	 ...
	 *
	 * This method prompts the user to enter the employee ID (created by admin) and
	 * the department ID (created by admin) to which the employee needs to be
	 * transferred.
	 * 
	 * The user's input is used to call the 'transferemployeetootherdepart' method
	 * in the 'AdminDAO' implementation.
	 * 
	 ...
	 *
	 * This method prompts the user to enter the department ID (created by admin) of
	 * the department to be deleted from the record.
	 * 
	 * The user's input is used to call the 'deleteDepartment' method in the
	 ...
	 *
	 * This method prints the options available for updating the leave status of an
	 * employee.
	 * 
	 * The options include accepting the leave, rejecting the leave, and going back
	...
	/**
	 * To Display the pending leave requests and allows the admin to accept or
	 * reject them.
	 *
	 * This method retrieves a list of pending leave requests from the admin DAO.
	 * 
	 * It then displays the details of each pending leave request, including leave
	 * ID, employee ID, employee name, days of leave, leave type, reason, date, and
	 * status.
	 * 
	 * The admin is prompted to choose an action: accept a leave request, reject a
	 * leave request, or go back.
	 * 
	 * The chosen action is executed by calling the corresponding method in the
	 * admin DAO.
	 * 
	 * Upon successful acceptance or rejection of a leave request, a success message
	 * is displayed.
	 * 
	 * If there are no pending leave requests then No Record found message is
	 * displayed but if an error occurs, an appropriate message is displayed.
	 */
	@Override
	void aceeptOrRejectLeavesOfEmployeeUI(Scanner sr) {
		...
		try {
			...
			System.out.println(ConsoleColor.BLACK_BACKGROUND_BRIGHT
					+ "+-------------------------------------------------------------------------------------------------------------------------+");
			System.out.println(
					"|                                                      List Of Panding Leave                                             |");
			System.out.println(
					"+------------+-----------+------------------+------------------+----------+------------------+---------------+------------+"
							+ ConsoleColor.RESET);
			System.out.println(
					"|  Leave_Id  |  empId    |     empName      |   days_of_leave  |   type   |      reason      |     date      |   status   |");
			System.out.println(
					"+------------+-----------+------------------+------------------+----------+------------------+---------------+------------+");
			map.forEach((i, obj) -> {
	 ...
	 *
	 * This method prompts the admin to enter the employee ID of the employee they
	 * want to fire.
	 * 
	 * It then calls the corresponding method in the admin DAO to remove the
	 * employee from the system.
	 * 
	 * If firing of the employee is successful, a success message is displayed.
	 * 
	 * If an error occurs or the employee is not found, an appropriate message is
	 * displayed.
	 */
	@Override
