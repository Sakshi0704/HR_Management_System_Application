...
/**
 * The AdminUI abstract class defines the interface for the administrative user
 * interface.
 * 
 * It provides methods to perform various administrative tasks such as managing
 * departments, employees, leaves, and other related operations.
 * 
 * Concrete implementations of this class are expected to provide the
 * implementation details for these methods based on the specific requirements
 * of the system.
 * 
 * @author Km Sakshi
 */
public abstract class AdminUI {
	...
	/**
	 * Displays the menu options for the admin dashboard. The menu includes various
	 * administrative tasks that an admin can perform such as adding new
	 * departments, viewing departments and employees, updating departments, adding
	 * new employees, transferring employees to other departments, accepting or
	 * rejecting employee leaves, firing employees, deleting departments, and
	 * exiting the admin dashboard.
	 *
	...
	/**
	 * Prompts the user to enter details for transferring an employee to another
	 * department
	 * 
	 * @param sr the Scanner object to read user input
	 */
	...
	/**
	 * Handles the admin functionality in the application. Allows admin to perform
	 * various actions based on their selection.
	 * 
	 * @param sr Scanner object to read user input
	 * @throws InterruptedException if there is an interruption while sleeping the
	 *                              thread
	 */
